...
class VideoPage1 extends StatefulWidget {
  _VideoPageState1 createState() => _VideoPageState1();
}

class _VideoPageState1 extends State<VideoPage1> {
  List<Video> _items;
  ...
  _getData() async {
    SearchListResponse response = await _youtubeService.getChannelVideos(
        UIData.youtubeChannel2Key, _nextPageToken);
